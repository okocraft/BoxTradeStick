...
dependencies {
    ...
    compileOnly("net.okocraft.box:box-api:5.2.0-SNAPSHOT")
    compileOnly("net.okocraft.box:box-storage-api:5.2.0-SNAPSHOT")
    compileOnly("net.okocraft.box:box-stick-feature:5.2.0-SNAPSHOT")
